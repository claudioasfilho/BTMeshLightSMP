...
{
  printf("evt:gecko_evt_mesh_scene_server_get_id, client_address=%u, \
appkey_index=%u\r\n",
         pEvt->client_address,
         pEvt->appkey_index);
}
...
{
  printf("evt:gecko_evt_mesh_scene_server_register_get_id, client_address=%u, \
appkey_index=%u\r\n",
         pEvt->client_address,
         pEvt->appkey_index);
}
...
{
  printf("evt:gecko_evt_mesh_scene_server_recall_id, client_address=%u, \
...
{
  printf("evt:gecko_evt_mesh_scene_server_publish_id, period_ms=%lu\r\n",
         pEvt->period_ms);
}
...
{
  printf("evt:gecko_evt_mesh_scene_setup_server_store_id, client_address=%u, \
...
{
  printf("evt:gecko_evt_mesh_scene_setup_server_delete_id, client_address=%u, \
appkey_index=%u, scene_id=%u\r\n",
         pEvt->client_address,
         pEvt->appkey_index,
         pEvt->scene_id);
...
{
  printf("evt:gecko_evt_mesh_scene_setup_server_publish_id, period_ms=%lu\r\n",
         pEvt->period_ms);
}
